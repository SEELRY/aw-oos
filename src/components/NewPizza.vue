<template>
    <form>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-11">
                <input type="text" class="form-contorl" v-model="newPizza.name">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-11">
                <input type="text" class="form-contorl" v-model="newPizza.size1">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-1">价格</label>
            <div class="col-sm-11">
                <input type="text" class="form-contorl" v-model="newPizza.price1">
            </div>
        </div>
        ...
        <div class="form-group row">
            <label class="col-sm-1">尺寸</label>
            <div class="col-sm-11">
                <input type="text" class="form-contorl" v-model="newPizza.size2">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-1">价格</label>
            <div class="col-sm-11">
                <input type="text" class="form-contorl" v-model="newPizza.price2">
            </div>
        </div>
        <div class="form-group row">
